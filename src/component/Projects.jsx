        ...
        >
          {projects.map((p) => (
            <motion.div 
              ...
              className="group relative bg-[#0a0a14]/60 border border-white/10 rounded-[2.5rem] p-3 hover:bg-[#1a1a24] hover:border-emerald-500/30 transition-all duration-500 flex flex-col hover:shadow-[0_0_50px_-15px_rgba(16,185,129,0.3)]"
            >
              {/* Image Container */}
              <div className="relative h-60 w-full rounded-[1.8rem] overflow-hidden z-10">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a14] via-[#0a0a14]/20 to-transparent opacity-90 z-10 transition-opacity duration-500 group-hover:opacity-100"></div>
